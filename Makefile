...
SRCS += utils/strcmp.c utils/parser.c utils/pipe_split.c utils/pipe_split_utils.c utils/util.c utils/ft_join.c pipes/pipes.c pipes/utils.c utils/error.c tokenizer/tokenizer.c
